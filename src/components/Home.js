...
export class Home extends Component {
  ...
  render() {
    ...
    const { tripsData, tripsDataError } = props;
          ...
          <div className="main-body">
            <div className="container">
              ...
              <div className="container trips-list">
                <div id="trips-group">
                  {tripsDataError && 'No Notifications Found!'}
                  {isLoading ? <i style={{ fontSize: '20px' }} className="fas fa-spinner fa-pulse" /> : null}
                  {tripsData && tripsData.data.map((trip) => (
                    <>
                      <div className="container one-trip">
                        ...
                        <div className="trip-more">
                          ...
                          <a href="#"><button style={{ marginBottom: '10px' }} type="button" name="button">More</button></a>
                        </div>
                      </div>
                      <hr />
                    </>
...
Home.propTypes = {
  getTripsAction: PropTypes.func.isRequired,
  tripsData: PropTypes.any,
  tripsDataError: PropTypes.any,
};

export const mapStateToProps = (state) => ({
  tripsData: state.tripsReducer.tripsData,
  tripsDataError: state.tripsReducer.tripsDataError,
  tripsStatus: state.tripsReducer.tripsStatus,
});

export default connect(mapStateToProps, { getTripsAction })(Home);
